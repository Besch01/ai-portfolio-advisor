...
# ============================
def plot_sector_allocation(conn):
    """
    Plot in a pie chart the sector allocation of portfolio's investments.
    """
    allocation = get_sector_allocation(conn)  # [(sector, percent), ...]
